...
// volatile bool IMUdataReady = false; // Set to true when MPU interrupt is triggered
...
// void readAngles() {
//   // Add your implementation for reading angles here
// }
...
//   trimAngle = (trimPot/100) + 5; // adjust to degrees
...
//     rightMotor.Stop(); 
//   } else {
//     leftMotor.Control(AIN1, speedLeft < 0 ? 1 : 0, PWMA_LEFT, abs(speedLeft));
//     rightMotor.Control(BIN1, speedRight < 0 ? 1 : 0, PWMB_RIGHT, abs(speedRight));
//   }

//   // move motors
//   if (speedLeft < 0) { 
//     leftMotor.Forward(abs(speedLeft));
//   } else {
//     leftMotor.Back(abs(speedLeft));
//   }
  
//   if (speedRight < 0) { 
//     rightMotor.Forward(abs(speedRight));
//   } else {
//     rightMotor.Back(abs(speedRight));
//   }
...
//   Serial.print(" , trimPot: ");
//   Serial.print(trimPot);
//   Serial.print(" , trimAngle: ");
//   Serial.println(trimAngle);
