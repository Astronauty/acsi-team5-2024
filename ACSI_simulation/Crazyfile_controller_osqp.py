...
if __name__ == '__main__':
    ...
    OSQP_crazyfile = QuadrotorLQR(dt=timestep)
    ...
    while robot.step(timestep) != -1:
        ...
        OSQP_crazyfile.update_x0(x_global,y_global,z_global,v_x_global,v_y_global,v_z_global,
        ...
        #############################################################
        """
        motor_power = res.x*100000000000000
